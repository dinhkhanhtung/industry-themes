...
const values = [
  {
    ...
    description: "Phía sau mỗi sản phẩm là một câu chuyện đầy cảm hứng đang chờ được kể. Chúng tôi tin rằng nghệ thuật thủ công không chỉ là trang trí, mà còn là ngôn ngữ truyền tải giá trị văn hóa và tâm hồn.",
  ...
  },
  {
    ...
    description: "Lấy cảm hứng từ vẻ đẹp của thiên nhiên và nghệ thuật truyền thống, mọi thiết kế của chúng tôi đều bắt nguồn từ di sản văn hóa phong phú. Mỗi chi tiết đều mang theo sự tôn kính đối với nghệ thuật cổ truyền.",
