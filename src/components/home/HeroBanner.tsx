...
const slides = [
  {
    ...
    description: "Khám phá bộ sưu tập đa dạng với chất lượng hàng đầu và dịch vụ tận tâm.",
    cta: "Khám phá ngay",
    href: "/san-pham",
  },
  {
    ...
    description: "Nâng cao kỹ năng với các khóa học được thiết kế bài bản bởi chuyên gia.",
    cta: "Đăng ký ngay",
    href: "/khoa-hoc",
  },
  {
    ...
    subtitle: "Đầy đủ, chất lượng cao",
    description: "Tất cả dụng cụ và phụ kiện bạn cần cho công việc và sáng tạo.",
    cta: "Mua ngay",
    href: "/phu-kien",
  },
];
